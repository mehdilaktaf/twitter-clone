...
import { web3_utils } from '../web3/provider.js'
...
export default class RegistrationForm extends React.Component {
  ...
  createUser = async (e) => {
    ...
    try {
      ...
      await createUser(web3_utils.fromAscii(username), web3_utils.fromAscii(firstName), web3_utils.fromAscii(lastName), bio, gravatarEmail)
